...
class PANVerificationRecord(BaseModel):
    num: constr(min_length=1) = Field(..., examples=['BBXPK2797M'])
    verifiedOn: constr(min_length=1) = Field(..., examples=['12-12-2018 12:53:57'])


class CertificateData1(BaseModel):
    PANVerificationRecord_1: Optional[PANVerificationRecord] = Field(
        None, alias='PANVerificationRecord'
    )
...
class Organization1(BaseModel):
    Address: Address2
    code: str = Field(..., examples=[''])
    name: constr(min_length=1) = Field(..., examples=['Income Tax Department'])
    tin: str = Field(..., examples=[''])
    type: constr(min_length=1) = Field(..., examples=['CG'])
    uid: str = Field(..., examples=[''])
...
class Person1(BaseModel):
    ...
    swdIndicator: constr(min_length=1) = Field(..., examples=['S'])
    title: str = Field(..., examples=[''])
    uid: str = Field(..., examples=[215051602786])
...
class PANVerificationRecordSchema(BaseModel):
    CertificateData: CertificateData1
    IssuedBy: IssuedBy1
    IssuedTo: IssuedTo1
    issueDate: str = Field(..., examples=[''])
    issuedAt: str = Field(..., examples=['Digilocker'])
    language: constr(min_length=1) = Field(..., examples=[99])
    name: constr(min_length=1) = Field(..., examples=['PAN Card'])
    number: constr(min_length=1) = Field(..., examples=['BBXPK2797M'])
    status: constr(min_length=1) = Field(..., examples=['A'])
    type: str = Field(..., examples=['PANCR'])
    validFromDate: str = Field(..., examples=[' '])
...
class CertificateParameters(BaseModel):
    ...
    PANFullName: str = Field(
        ..., description='Name as in PAN Card', examples=['RAMESHWAR KUMAR SINGH']
    )
    UID: str = Field(..., description='Aadhaar number', examples=['123412341234'])
    panno: str = Field(..., description='PAN No.', examples=['ABCD123EF'])
...
class PancrCertificatePostRequest(BaseModel):
...
class PancrCertificatePostResponse(BaseModel):
...
class PancrCertificatePostResponse1(BaseModel):
...
class PancrCertificatePostResponse2(BaseModel):
...
class PancrCertificatePostResponse3(BaseModel):
...
class PancrCertificatePostResponse4(BaseModel):
...
class PancrCertificatePostResponse5(BaseModel):
...
class PancrCertificatePostResponse6(BaseModel):
